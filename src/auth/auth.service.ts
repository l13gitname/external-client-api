import { IResUserData } from 'src/interface/i-res-user.interface';
...
export class AuthService {
    ...
    async login(user: IResUserV2Data) {
        ...
        const access_token = this.jwtService.sign(payload, { secret: this.configService.get<string>('JWT_KEY') })
